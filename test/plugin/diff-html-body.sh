...
normalize_html_body() {
  # Remove the "Last updated" line BEFORE parsing, and also ignore strypify version numbers in the file names:
  cleaned=$1.cleaned
  grep -v 'Last updated' "$1" | sed 's/strypify[0-9.][0-9.]*/strypifyXXX/g' > "$cleaned"
